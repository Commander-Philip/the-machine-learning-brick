...
* To load the model with weights:
    ...
    import model_with_classification_and_fully_connected_layer
    model = model_with_classification_and_fully_connected_layer.load_model()


* To load the model without weights:

    import model_with_classification_and_fully_connected_layer
    model = model_with_classification_and_fully_connected_layer.load_model(load_weights=False)
