...
void emxEnsureCapacity_cell_wrap_42(emxArray_cell_wrap_42 *emxArray,
                                    int oldNumel)
{
  int i;
  int newNumel;
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    newData = calloc((unsigned int)newCapacity, sizeof(cell_wrap_42));
    if (emxArray->data != NULL) {
      memcpy(newData, emxArray->data,
             sizeof(cell_wrap_42) * (unsigned int)oldNumel);
      if (emxArray->canFreeData) {
        free(emxArray->data);
      }
    }
    emxArray->data = (cell_wrap_42 *)newData;
    emxArray->allocatedSize = newCapacity;
    emxArray->canFreeData = true;
  }
  if (oldNumel > newNumel) {
    emxTrim_cell_wrap_42(emxArray, newNumel, oldNumel);
  } else if (oldNumel < newNumel) {
    emxExpand_cell_wrap_42(emxArray, oldNumel, newNumel);
  }
}
...
void emxEnsureCapacity_struct_T(emxArray_struct_T *emxArray, int oldNumel)
{
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    newData = malloc((unsigned int)newCapacity * sizeof(struct_T));
    if (emxArray->data != NULL) {
      memcpy(newData, emxArray->data,
...
void emxEnsureCapacity_struct_T1(b_emxArray_struct_T *emxArray, int oldNumel)
{
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    newData = calloc((unsigned int)newCapacity, sizeof(b_struct_T));
    if (emxArray->data != NULL) {
      memcpy(newData, emxArray->data,
...
void emxExpand_cell_wrap_42(emxArray_cell_wrap_42 *emxArray, int fromIndex,
                            int toIndex)
{
  int i;
  for (i = fromIndex; i < toIndex; i++) {
    emxInitStruct_cell_wrap_42(&emxArray->data[i]);
  }
}
...
void emxFreeStruct_cell_wrap_42(cell_wrap_42 *pStruct)
{
...
void emxFree_cell_wrap_42(emxArray_cell_wrap_42 **pEmxArray)
{
  int i;
  if (*pEmxArray != (emxArray_cell_wrap_42 *)NULL) {
    if ((*pEmxArray)->data != (cell_wrap_42 *)NULL) {
      int numEl;
      numEl = 1;
      ...
      for (i = 0; i < numEl; i++) {
        emxFreeStruct_cell_wrap_42(&(*pEmxArray)->data[i]);
      }
    ...
    free((*pEmxArray)->size);
    free(*pEmxArray);
    *pEmxArray = (emxArray_cell_wrap_42 *)NULL;
  }
}
...
void emxInitStruct_cell_wrap_42(cell_wrap_42 *pStruct)
{
...
void emxInit_cell_wrap_42(emxArray_cell_wrap_42 **pEmxArray)
{
  emxArray_cell_wrap_42 *emxArray;
  int i;
  *pEmxArray = (emxArray_cell_wrap_42 *)malloc(sizeof(emxArray_cell_wrap_42));
  emxArray = *pEmxArray;
  emxArray->data = (cell_wrap_42 *)NULL;
...
void emxTrim_cell_wrap_42(emxArray_cell_wrap_42 *emxArray, int fromIndex,
                          int toIndex)
{
  int i;
  for (i = fromIndex; i < toIndex; i++) {
    emxFreeStruct_cell_wrap_42(&emxArray->data[i]);
  }
}
...
/* End of code generation (bildvorverarbeitung_emxutil.c) */
